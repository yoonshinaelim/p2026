...
const Main = () => {
    ...
    useEffect(() => {
      ...
      tl.to(chars, {opacity: 1, y: 0, duration: 0.2, ease: 'power2.out', stagger: 0.08});
      tl.to(imageInner, {opacity: 1, scale: 1, duration: 0.2,ease: 'power2.out'}, '>-0.2');
      ...
      section3Tween.fromTo(section3Chars, { opacity: 0, y: 50 },{ opacity: 1, y: 0, duration:0.3, ease: 'power2.out', stagger: 0.05 })
      .fromTo(section3Text, { opacity: 0, y: 50 },{ opacity: 1, y: 0, duration:0.3, ease: 'power2.out', stagger: 0.05 })
      .fromTo(section3Btn, { opacity: 0, y: 50 },{ opacity: 1, y: 0, duration:0.3, ease: 'power2.out', stagger: 0.05 });
